 ...
 */
public class KOLFollowerCrawler extends Crawler {
    ...
    /// ____Constructor____ ///
    public KOLFollowerCrawler(WebDriver driver, Gson gson,
    ...
    public void navigate() {
        System.out.println("/// Inspecting follower KOL");
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.cssSelector("a[href='/" + handle_name + "/verified_followers']"))).click();
    ...
    public boolean crawl () {
        ...
        for (String handle: handles) {
            if (kol_map_jsonObject.has(handle)) {
                ...
                target_jsonObject.get("follower_kol_handle_list").getAsJsonArray().add(handle);
            }
        }
