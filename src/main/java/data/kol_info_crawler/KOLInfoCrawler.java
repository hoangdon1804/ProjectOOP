...
public class KOLInfoCrawler extends Crawler {
      ...
      private static final int MIN_KOL_FOLLOWER = 20000;
      ...
      private int crawlProfilesData(List<WebElement> profiles) {
            ...
            for (WebElement profile: profiles) {
                  ...
                  if (total_count == 0) {
                        ...
                        long distance_to_top = ((Number) js_executor.executeScript("return arguments[0].getBoundingClientRect().top;", profile)).longValue();
                  ...
                  WebElement back = driver.findElement(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main"));
                  back.click();
                  Sleeper.sleep(500);
      ...
      private boolean crawlOneProfileData(WebElement profile) throws StaleElementReferenceException {
           ...
           try {
                 ...
                 System.out.println("HoverCard not found");
           }
